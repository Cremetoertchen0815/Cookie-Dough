...
Namespace Game.BetretenVerboten
    ...
    Public Class GameInstance
        ...
        '        Dim mapp As GaemMap
        '        If Not LocalClient.JoinGame(ins, index, AktuellerSlave.Spielers, AktuellerSlave.Rejoin, mapp) Then Return
        ...
        '        Core.StartSceneTransition(New FadeTransition(Function() AktuellerSlave)).OnTransitionCompleted = Sub() AktuellerSlave.SendArrived()
