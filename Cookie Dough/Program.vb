...
Public Module Program
    ...
    Friend Property hudcolors As Color() = {Color.Magenta, Color.Lime, Color.Cyan, Color.Orange, New Color(255, 32, 32), New Color(85, 120, 20), Color.Teal, New Color(48, 48, 255)}
