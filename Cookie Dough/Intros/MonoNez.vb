...
Namespace Intros
    Public Class MonoNez
        ...
        Public Overrides Sub Initialize()
            ...
            Core.Schedule(1.5, Sub() Core.StartSceneTransition(New FadeTransition(Function() New Menu.MainMenu.SplashScreen) With {.FadeInDuration = 1, .FadeOutDuration = 0.7, .FadeToColor = Color.Black, .FadeEaseType = Tweens.EaseType.QuadInOut}))
        End Sub
