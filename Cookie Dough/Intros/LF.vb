...
Namespace Intros
    Public Class LFIntro
        ...
        Private Class LfIntroRenderer
            ...
            Private ow As LFIntro

            'Sounds
            Private jmp As SoundEffect
            Private kill As SoundEffect

            Sub New(order As Integer, owner As LFIntro)
                MyBase.New(order)
                ow = owner
            End Sub
        ...
        Public Class PsygroundRenderer
            ...
            'TODO!!!!
            'Kick out this cunt of a shader(A heartfelt fuck you to MGCB for compiling custom fx in an outdated version!) and replace him with a Basic Effect.
            'SERIOUSLY! Instead of tinkering for 3 damn hours on this old and broken shader, I couldv'e simply used the good ol' BasicEffect instead.
            'All I needed was to render the albedo with vertex colors. "Custom stencil shader necessairy"... MY ASS!
            ...
            Private Effect As BasicEffect 'aka the devil
            Private Dev As GraphicsDevice
            ...
            Public Property StencilTexture As Texture2D = pixl
            Public Property Alpha As Single = 1.0F
